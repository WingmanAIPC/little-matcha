...
export const videos = A({
  ...
  cafe: {
    ...
    kind: "video",
    src: "/videos/cafe.mp4",
    poster: "/images/gallery-counter.png",
  ...
  seasonal: {
    ...
    poster: "/images/drink-seasonal.png",
...
export const images = A({
  ...
  drinkGenmaicha: {
    id: "drinkGenmaicha",
    kind: "image",
    src: "/images/drink-genmaicha.png",
    alt: "Genmaicha latte",
    aspect: "1/1",
    tone: "matcha",
    prompt:
  ...
  galleryCounter: {
    id: "galleryCounter",
    kind: "image",
    src: "/images/gallery-counter.png",
